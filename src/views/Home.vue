<template>
    <vc-view active-panel="main">
        <vc-modal-root slot="modal" :active-modal="activeModal" @close="activeModal = null">
            <vc-modal-card name="subscribe" :actions="subscribeActions" @close="activeModal = null">
                <vc-icon-56-mention-outline slot="icon"/>
        ...
        <vc-panel name="main">
            ...
            <vc-group>
                ...
                <vc-form-layout tag="div">
                    <vc-input v-model="subscribeMail" top="Ваша почта"/>
                    <vc-button size="xl" mode="secondary" @click="activeModal = 'subscribe'">Подписаться</vc-button>
                </vc-form-layout>
            </vc-group>
            <vc-div></vc-div>
            <vc-div></vc-div>
